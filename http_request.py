...
def http_post(module, url, access_token, status_code, data):
    return http_request(module, "POST", url, access_token, status_code, data)
...
def http_request(module, method,url, access_token, status_code, data):
    try:
...
def main():
    ...
    (changed, result, status_code) = http_request(module)
